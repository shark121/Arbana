...
export async function POST(req: NextRequest) {
  ...
  await completePayment({ reference, trxref, eventId, ticketId, userId }).then((res) => {
    console.log(res, "payment response data...............");
  }).catch((err) => {
    console.log(err, "payment response data...............");
  });
  ...
  //         if (data[ticketId]) {
  //           data[ticketId].scans = data[ticketId]?.groupNumber ? data[ticketId].quantity * data[ticketId].groupNumber : data[ticketId].quantity;
